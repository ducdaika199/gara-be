...
export class StrykerInitializer {
    ...
    async initiateCustom(configWriter) {
        ...
        const configFileName = await configWriter.write(selectedTestRunner, buildCommand, selectedReporters, selectedPackageManager, npmDependencies.map((pkg) => pkg.name), additionalConfig, (_a = pkgInfoOfSelectedTestRunner === null || pkgInfoOfSelectedTestRunner === void 0 ? void 0 : pkgInfoOfSelectedTestRunner.homepage) !== null && _a !== void 0 ? _a : 'URL not found', isJsonSelected);
